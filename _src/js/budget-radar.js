...
//--------------------------------------------------
// DROP THIS WHEN DROPDOWNS ARE DONE
//          hash.shift();
//          hash.shift();          
          //--------------------------------------------------
          console.log("hash",hash);
          var hashTop              = getLevel(data,hash);
          var topLevelBudgetValues = hashTop.values;
          ...
          var validAxis = function (o) { return hasKey(o) && hasData(o) && hasAmount(o.data); }    ;
